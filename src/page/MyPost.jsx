...
const MyPost = () => {
  ...
  return (
    <div>
      ...
      </div> : <h1 style={{ display: 'flex', color: 'white', justifyContent: 'center', marginTop: '10%' }}>You haven't published any posts.</h1>}</> : <h1 style={{ display: 'flex', justifyContent: 'center', color: 'white' }}>
